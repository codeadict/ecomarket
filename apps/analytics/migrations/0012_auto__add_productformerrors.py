...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductFormErrors'
        db.create_table('analytics_productformerrors', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Stall'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Product'], null=True, blank=True)),
            ('product_form_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('price_form_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shipping_form_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rules_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('images_formset_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('description_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('recipients_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('title_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('colors_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('keywords_field_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('primary_category_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shipping_profile_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('amount_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('analytics', ['ProductFormErrors'])


    def backwards(self, orm):
        # Deleting model 'ProductFormErrors'
        db.delete_table('analytics_productformerrors')
    ...
    models = {
        ...
        'analytics.productformerrors': {
            ...
            'rules_error': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
