...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LifetimeTrack.actual_activated_at'
        db.add_column('analytics_lifetimetrack', 'actual_activated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LifetimeTrack.actual_retained_at'
        db.add_column('analytics_lifetimetrack', 'actual_retained_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LifetimeTrack.actual_referred_at'
        db.add_column('analytics_lifetimetrack', 'actual_referred_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LifetimeTrack.actual_activated_at'
        db.delete_column('analytics_lifetimetrack', 'actual_activated_at')

        # Deleting field 'LifetimeTrack.actual_retained_at'
        db.delete_column('analytics_lifetimetrack', 'actual_retained_at')

        # Deleting field 'LifetimeTrack.actual_referred_at'
        db.delete_column('analytics_lifetimetrack', 'actual_referred_at')
