...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignTrack.query_string'
        db.add_column('analytics_campaigntrack', 'query_string',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CampaignTrack.name'
        db.alter_column('analytics_campaigntrack', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'CampaignTrack.utmz'
        db.alter_column('analytics_campaigntrack', 'utmz', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):
        # Deleting field 'CampaignTrack.query_string'
        db.delete_column('analytics_campaigntrack', 'query_string')
