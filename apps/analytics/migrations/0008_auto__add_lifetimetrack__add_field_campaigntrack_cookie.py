...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LifetimeTrack'
        db.create_table('analytics_lifetimetrack', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cookie_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User'])),
            ('email_lead', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mailing_lists.MailingListSignup'])),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('acquired_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('activated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('retained_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('referred_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('purchased_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('analytics', ['LifetimeTrack'])

        # Adding field 'CampaignTrack.cookie'
        db.add_column('analytics_campaigntrack', 'cookie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analytics.LifetimeTrack'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LifetimeTrack'
        db.delete_table('analytics_lifetimetrack')

        # Deleting field 'CampaignTrack.cookie'
        db.delete_column('analytics_campaigntrack', 'cookie_id')
