...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignTrack.email_lead'
        db.add_column('analytics_campaigntrack', 'email_lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='campaigns', null=True, to=orm['mailing_lists.MailingListSignup']),
                      keep_default=False)


        # Changing field 'CampaignTrack.user'
        db.alter_column('analytics_campaigntrack', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'CampaignTrack.email_lead'
        db.delete_column('analytics_campaigntrack', 'email_lead_id')


        # Changing field 'CampaignTrack.user'
        db.alter_column('analytics_campaigntrack', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
