...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AggregateData.order_count'
        db.add_column('analytics_aggregatedata', 'order_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AggregateData.order_count'
        db.delete_column('analytics_aggregatedata', 'order_count')
