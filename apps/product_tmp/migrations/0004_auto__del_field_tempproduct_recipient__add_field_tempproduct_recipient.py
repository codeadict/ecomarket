...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TempProduct.recipients'
        db.add_column('product_tmp_tempproduct', 'recipients',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TempProduct.recipients'
        db.delete_column('product_tmp_tempproduct', 'recipients')
    ...
    models = {
        ...
        'product_tmp.tempproduct': {
            ...
            'recipients': ('django.db.models.fields.TextField', [], {'default': "''"}),
