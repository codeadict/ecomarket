...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TempProduct.last_updated_by'
        db.add_column('product_tmp_tempproduct', 'last_updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TempProduct.last_updated_by'
        db.delete_column('product_tmp_tempproduct', 'last_updated_by_id')
    ...
    models = {
        ...
        'product_tmp.tempproduct': {
            ...
            'last_updated_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            ...
            'recipient': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
