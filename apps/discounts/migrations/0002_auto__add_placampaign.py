...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PLACampaign'
        db.create_table('discounts_placampaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('utm_source', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('utm_medium', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('utm_campaign', self.gf('django.db.models.fields.CharField')(max_length=127)),
        ))
        db.send_create_signal('discounts', ['PLACampaign'])

        # Adding M2M table for field countries on 'PLACampaign'
        db.create_table('discounts_placampaign_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('placampaign', models.ForeignKey(orm['discounts.placampaign'], null=False)),
            ('country', models.ForeignKey(orm['marketplace.country'], null=False))
        ))
        db.create_unique('discounts_placampaign_countries', ['placampaign_id', 'country_id'])

        # Adding M2M table for field products on 'PLACampaign'
        db.create_table('discounts_placampaign_products', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('placampaign', models.ForeignKey(orm['discounts.placampaign'], null=False)),
            ('product', models.ForeignKey(orm['marketplace.product'], null=False))
        ))
        db.create_unique('discounts_placampaign_products', ['placampaign_id', 'product_id'])


    def backwards(self, orm):
        # Deleting model 'PLACampaign'
        db.delete_table('discounts_placampaign')

        # Removing M2M table for field countries on 'PLACampaign'
        db.delete_table('discounts_placampaign_countries')

        # Removing M2M table for field products on 'PLACampaign'
        db.delete_table('discounts_placampaign_products')
    ...
    models = {
        ...
        'discounts.placampaign': {
            ...
            'countries': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['marketplace.Country']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['marketplace.Product']", 'symmetrical': 'False'}),
