# Taken from https://github.com/etianen/django-optimizations/blob/master/src/optimizations/propertycache.py
# Copyright (c) 2009, David Hall.
# See https://github.com/etianen/django-optimizations/blob/master/LICENSE
"""
