...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.logged_to_google'
        db.add_column('purchase_payment', 'logged_to_google',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.logged_to_google'
        db.delete_column('purchase_payment', 'logged_to_google')
