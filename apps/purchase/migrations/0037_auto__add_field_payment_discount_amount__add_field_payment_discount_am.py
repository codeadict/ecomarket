...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.discount_amount'
        db.add_column('purchase_payment', 'discount_amount',
                      self.gf('marketplace.fields.NullableMoneyField')(default=0, no_currency_field=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Payment.discount_amount_currency'
        db.add_column('purchase_payment', 'discount_amount_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default="GBP", max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.discount_amount'
        db.delete_column('purchase_payment', 'discount_amount')

        # Deleting field 'Payment.discount_amount_currency'
        db.delete_column('purchase_payment', 'discount_amount_currency')
    ...
    models = {
        ...
        'purchase.cart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'cart'", 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'purchase.cartstall': {
            ...
            'coupon_code': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'purchase.order': {
            ...
            'discount_amount': ('marketplace.fields.NullableMoneyField', [], {'default': '0', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'discount_amount_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': "'GBP'", 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'purchase.payment': {
            ...
            'discount_amount_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': "'GBP'", 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logged_to_google': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
