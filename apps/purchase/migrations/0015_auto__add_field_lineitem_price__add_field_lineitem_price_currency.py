...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineItem.price'
        db.add_column('purchase_lineitem', 'price',
        ...
        # Adding field 'LineItem.price_currency'
        db.add_column('purchase_lineitem', 'price_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LineItem.price'
        db.delete_column('purchase_lineitem', 'price')

        # Deleting field 'LineItem.price_currency'
        db.delete_column('purchase_lineitem', 'price_currency')
    ...
    models = {
        ...
        'purchase.cartstall': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['purchase.Order']", 'null': 'True'}),
