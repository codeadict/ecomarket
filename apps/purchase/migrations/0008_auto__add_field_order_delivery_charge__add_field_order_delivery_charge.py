...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.delivery_charge'
        db.add_column('purchase_order', 'delivery_charge',
        ...
        # Adding field 'Order.delivery_charge_currency'
        db.add_column('purchase_order', 'delivery_charge_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.delivery_charge'
        db.delete_column('purchase_order', 'delivery_charge')

        # Deleting field 'Order.delivery_charge_currency'
        db.delete_column('purchase_order', 'delivery_charge_currency')
    ...
    models = {
        ...
        'purchase.order': {
            ...
            'delivery_charge_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': 'None', 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
