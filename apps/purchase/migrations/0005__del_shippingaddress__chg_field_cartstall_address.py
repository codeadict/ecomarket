...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('accounts', '0002_add_shippingaddress'),
    )

    def forwards(self, orm):
        # Changing field 'CartStall.address'
        db.alter_column('purchase_cartstall', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.ShippingAddress']))

    def backwards(self, orm):
        # Changing field 'CartStall.address'
        db.alter_column('purchase_cartstall', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['purchase.ShippingAddress']))
