...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('purchase_payment', 'amount', self.gf('marketplace.fields.NullableMoneyField')(no_currency_field=True, max_digits=6, decimal_places=2, default=0))

        # Changing field 'LineItem.price'
        db.alter_column('purchase_lineitem', 'price', self.gf('marketplace.fields.NullableMoneyField')(no_currency_field=True, max_digits=6, decimal_places=2, default=0))

        # Changing field 'Order.delivery_charge'
        db.alter_column('purchase_order', 'delivery_charge', self.gf('marketplace.fields.NullableMoneyField')(no_currency_field=True, max_digits=6, decimal_places=2, default=0))

        # Changing field 'CartProduct.unit_price'
        db.alter_column('purchase_cartproduct', 'unit_price', self.gf('marketplace.fields.NullableMoneyField')(no_currency_field=True, max_digits=6, decimal_places=2, default=0))

    def backwards(self, orm):

        # Changing field 'Payment.amount'
        db.alter_column('purchase_payment', 'amount', self.gf('money.contrib.django.models.fields.MoneyField')(no_currency_field=True, max_digits=6, decimal_places=2))

        # Changing field 'LineItem.price'
        db.alter_column('purchase_lineitem', 'price', self.gf('money.contrib.django.models.fields.MoneyField')(no_currency_field=True, max_digits=6, decimal_places=2))

        # Changing field 'Order.delivery_charge'
        db.alter_column('purchase_order', 'delivery_charge', self.gf('money.contrib.django.models.fields.MoneyField')(no_currency_field=True, max_digits=6, decimal_places=2))

        # Changing field 'CartProduct.unit_price'
        db.alter_column('purchase_cartproduct', 'unit_price', self.gf('money.contrib.django.models.fields.MoneyField')(no_currency_field=True, max_digits=6, decimal_places=2))
    ...
    models = {
        ...
        'purchase.cartproduct': {
            ...
            'unit_price': ('marketplace.fields.NullableMoneyField', [], {'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'purchase.cartstall': {
            ...
            'speculative_country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['marketplace.Country']", 'null': 'True'}),
        ...
        'purchase.lineitem': {
            ...
            'price': ('marketplace.fields.NullableMoneyField', [], {'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'purchase.order': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.ShippingAddress']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'delivery_charge': ('marketplace.fields.NullableMoneyField', [], {'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'delivery_charge_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': "'GBP'", 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_joomla_order': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'purchase.payment': {
            ...
            'amount': ('marketplace.fields.NullableMoneyField', [], {'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'payment'", 'unique': 'True', 'null': 'True', 'to': "orm['purchase.Order']"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '200'}),
        ...
        'purchase.paymentattempt': {
            'Meta': {'object_name': 'PaymentAttempt'},
            'cart_stall': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_attempts'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['purchase.CartStall']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'payment_attempt'", 'unique': 'True', 'to': "orm['purchase.Payment']"}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'purchase.refund': {
