...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('purchase_payment', 'status', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Payment.status'
        db.alter_column('purchase_payment', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
