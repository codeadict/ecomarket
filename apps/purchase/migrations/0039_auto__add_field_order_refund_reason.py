...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.refund_reason'
        db.add_column('purchase_order', 'refund_reason',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.refund_reason'
        db.delete_column('purchase_order', 'refund_reason')
    ...
    models = {
        ...
        'purchase.order': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'refund_reason': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        'purchase.paymentreturnredirect': {
            'Meta': {'object_name': 'PaymentReturnRedirect'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment_already_processed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
