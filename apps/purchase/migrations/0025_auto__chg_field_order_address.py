...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.address'
        db.alter_column('purchase_order', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.ShippingAddress']))

    def backwards(self, orm):

        # Changing field 'Order.address'
        db.alter_column('purchase_order', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ShippingAddress'], null=True))
