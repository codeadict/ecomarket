...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Refund.order'
        db.add_column('purchase_refund', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='refunds', to=orm['purchase.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Refund.order'
        db.delete_column('purchase_refund', 'order_id')
