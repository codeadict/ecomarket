...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('purchase_order', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ShippingAddress'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.address'
        db.delete_column('purchase_order', 'address_id')
    ...
    models = {
        ...
        'purchase.order': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.ShippingAddress']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
