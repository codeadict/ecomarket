...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.order'
        db.alter_column('purchase_payment', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['purchase.Order']))
        # Deleting field 'CartStall.order'
        db.delete_column('purchase_cartstall', 'order_id')


        # Changing field 'PaymentAttempt.cart_stall'
        db.alter_column('purchase_paymentattempt', 'cart_stall_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['purchase.CartStall']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.order'
        raise RuntimeError("Cannot reverse this migration. 'Payment.order' and its values cannot be restored.")
        # Adding field 'CartStall.order'
        db.add_column('purchase_cartstall', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='cart_stall', unique=True, null=True, to=orm['purchase.Order']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PaymentAttempt.cart_stall'
        raise RuntimeError("Cannot reverse this migration. 'PaymentAttempt.cart_stall' and its values cannot be restored.")
    ...
    models = {
        ...
        'marketplace.shippingprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'others_delivery_time': ('django.db.models.fields.IntegerField', [], {}),
            'others_delivery_time_max': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'purchase.paymentattempt': {
            ...
            'cart_stall': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_attempts'", 'null': 'True', 'to': "orm['purchase.CartStall']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
