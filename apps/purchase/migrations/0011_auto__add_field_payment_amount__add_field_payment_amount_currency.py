...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('purchase_payment', 'amount',
        ...
        # Adding field 'Payment.amount_currency'
        db.add_column('purchase_payment', 'amount_currency',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('purchase_payment', 'amount')

        # Deleting field 'Payment.amount_currency'
        db.delete_column('purchase_payment', 'amount_currency')
