...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['order']
        db.delete_unique('purchase_payment', ['order_id'])


        # Changing field 'Payment.order'
        db.alter_column('purchase_payment', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.Order']))

    def backwards(self, orm):

        # Changing field 'Payment.order'
        db.alter_column('purchase_payment', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['purchase.Order']))
        # Adding unique constraint on 'Payment', fields ['order']
        db.create_unique('purchase_payment', ['order_id'])
    ...
    models = {
        ...
        'purchase.payment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments'", 'to': "orm['purchase.Order']"}),
