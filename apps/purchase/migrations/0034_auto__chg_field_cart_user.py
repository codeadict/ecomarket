...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('purchase_cart', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Cart.user'
        db.alter_column('purchase_cart', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, unique=True, to=orm['auth.User']))
