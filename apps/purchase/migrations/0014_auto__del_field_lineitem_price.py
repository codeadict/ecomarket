...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('purchase_lineitem', 'price_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LineItem.price'
        raise RuntimeError("Cannot reverse this migration. 'LineItem.price' and its values cannot be restored.")
