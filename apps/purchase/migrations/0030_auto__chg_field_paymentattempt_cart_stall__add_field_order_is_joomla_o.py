...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('purchase_paymentattempt', 'cart_stall_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['purchase.CartStall']))
        # Adding field 'Order.is_joomla_order'
        db.add_column('purchase_order', 'is_joomla_order',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.is_joomla_order'
        db.delete_column('purchase_order', 'is_joomla_order')
