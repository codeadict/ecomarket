...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShippingAddress.cart_stall'
        db.delete_column('purchase_shippingaddress', 'cart_stall_id')


    def backwards(self, orm):
        # Adding field 'ShippingAddress.cart_stall'
        # Set 0 as default, the data migration 0003 updates this field based on the
        # ShippingAddress related_name before removing the cartstall.address_id field
        db.add_column('purchase_shippingaddress', 'cart_stall',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='shipping_address', unique=True, to=orm['purchase.CartStall']),
                      keep_default=False)
