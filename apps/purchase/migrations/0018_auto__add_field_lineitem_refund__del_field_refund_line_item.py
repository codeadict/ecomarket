...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineItem.refund'
        db.add_column('purchase_lineitem', 'refund',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='line_items', null=True, to=orm['purchase.Refund']),
                      keep_default=False)

        # Deleting field 'Refund.line_item'
        db.delete_column('purchase_refund', 'line_item_id')


    def backwards(self, orm):
        # Deleting field 'LineItem.refund'
        db.delete_column('purchase_lineitem', 'refund_id')


        # User chose to not deal with backwards NULL issues for 'Refund.line_item'
        raise RuntimeError("Cannot reverse this migration. 'Refund.line_item' and its values cannot be restored.")
