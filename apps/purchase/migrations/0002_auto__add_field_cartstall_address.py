...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartStall.address'
        db.add_column('purchase_cartstall', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart_stalls', null=True, to=orm['purchase.ShippingAddress']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartStall.address'
        db.delete_column('purchase_cartstall', 'address_id')
