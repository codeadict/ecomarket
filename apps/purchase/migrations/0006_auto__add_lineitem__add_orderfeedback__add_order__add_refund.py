...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('purchase_lineitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='line_items', to=orm['purchase.Order'])),
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Price'])),
        ...
        db.send_create_signal('purchase', ['LineItem'])

        # Adding model 'OrderFeedback'
        db.create_table('purchase_orderfeedback', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(related_name='feedback', unique=True, null=True, to=orm['purchase.Order'])),
            ('feedback_text', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['OrderFeedback'])

        # Adding model 'Order'
        db.create_table('purchase_order', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['auth.User'])),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['marketplace.Stall'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['Order'])

        # Adding model 'Refund'
        db.create_table('purchase_refund', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('line_item', self.gf('django.db.models.fields.related.OneToOneField')(related_name='refund', unique=True, to=orm['purchase.LineItem'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['Refund'])


    def backwards(self, orm):
        # Deleting model 'LineItem'
        db.delete_table('purchase_lineitem')

        # Deleting model 'OrderFeedback'
        db.delete_table('purchase_orderfeedback')

        # Deleting model 'Order'
        db.delete_table('purchase_order')

        # Deleting model 'Refund'
        db.delete_table('purchase_refund')
    ...
    models = {
        ...
        'purchase.lineitem': {
            ...
            'price': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['marketplace.Price']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['marketplace.Product']"}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'purchase.order': {
        ...
        'purchase.refund': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line_item': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'refund'", 'unique': 'True', 'to': "orm['purchase.LineItem']"}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
