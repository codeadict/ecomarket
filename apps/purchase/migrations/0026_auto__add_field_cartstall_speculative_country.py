...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartStall.speculative_country'
        db.add_column('purchase_cartstall', 'speculative_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Country'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartStall.speculative_country'
        db.delete_column('purchase_cartstall', 'speculative_country_id')
