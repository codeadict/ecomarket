...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cart'
        db.create_table('purchase_cart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carts', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['Cart'])

        # Adding model 'CartStall'
        db.create_table('purchase_cartstall', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart_stalls', to=orm['purchase.Cart'])),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Stall'])),
            ...
            ('checked_out_on', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['CartStall'])

        # Adding model 'CartProduct'
        db.create_table('purchase_cartproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart_stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart_products', to=orm['purchase.CartStall'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Product'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('unit_price', self.gf('money.contrib.django.models.fields.MoneyField')(default=None, no_currency_field=True, max_digits=6, decimal_places=2, blank=True)),
            ('unit_price_currency', self.gf('money.contrib.django.models.fields.CurrencyField')(default=None, max_length=3)),
        ))
        db.send_create_signal('purchase', ['CartProduct'])

        # Adding model 'Payment'
        db.create_table('purchase_payment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart_stall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.CartStall'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('secret_uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ...
        db.send_create_signal('purchase', ['Payment'])

        # Adding model 'ShippingAddress'
        db.create_table('purchase_shippingaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='addresses', to=orm['auth.User'])),
            ('cart_stall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='shipping_address', unique=True, to=orm['purchase.CartStall'])),
        ...
        db.send_create_signal('purchase', ['ShippingAddress'])


    def backwards(self, orm):
        # Deleting model 'Cart'
        db.delete_table('purchase_cart')

        # Deleting model 'CartStall'
        db.delete_table('purchase_cartstall')

        # Deleting model 'CartProduct'
        db.delete_table('purchase_cartproduct')

        # Deleting model 'Payment'
        db.delete_table('purchase_payment')

        # Deleting model 'ShippingAddress'
        db.delete_table('purchase_shippingaddress')
