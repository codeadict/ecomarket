...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.discount_amount'
        db.add_column('purchase_order', 'discount_amount',
                      self.gf('marketplace.fields.NullableMoneyField')(default=0, no_currency_field=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.discount_amount_currency'
        db.add_column('purchase_order', 'discount_amount_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.discount_amount'
        db.delete_column('purchase_order', 'discount_amount')

        # Deleting field 'Order.discount_amount_currency'
        db.delete_column('purchase_order', 'discount_amount_currency')
