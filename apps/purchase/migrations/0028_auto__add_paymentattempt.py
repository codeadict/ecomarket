...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('purchase_paymentattempt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart_stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_attempts', to=orm['purchase.CartStall'])),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(related_name='payment_attempt', unique=True, to=orm['purchase.Payment'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('purchase', ['PaymentAttempt'])


    def backwards(self, orm):
        # Deleting model 'PaymentAttempt'
        db.delete_table('purchase_paymentattempt')
    ...
    models = {
        ...
        'purchase.paymentattempt': {
            ...
            'cart_stall': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_attempts'", 'to': "orm['purchase.CartStall']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
