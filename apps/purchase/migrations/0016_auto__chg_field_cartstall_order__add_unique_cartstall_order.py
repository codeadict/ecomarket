...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CartStall.order'
        db.alter_column('purchase_cartstall', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['purchase.Order']))
        # Adding unique constraint on 'CartStall', fields ['order']
        db.create_unique('purchase_cartstall', ['order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CartStall', fields ['order']
        db.delete_unique('purchase_cartstall', ['order_id'])


        # Changing field 'CartStall.order'
        db.alter_column('purchase_cartstall', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.Order'], null=True))
