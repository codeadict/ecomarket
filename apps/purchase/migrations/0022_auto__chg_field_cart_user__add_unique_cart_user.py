...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('purchase_cart', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Cart', fields ['user']
        db.create_unique('purchase_cart', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cart', fields ['user']
        db.delete_unique('purchase_cart', ['user_id'])


        # Changing field 'Cart.user'
        db.alter_column('purchase_cart', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
