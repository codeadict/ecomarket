...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartStall.coupon_code'
        db.add_column('purchase_cartstall', 'coupon_code',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartStall.coupon_code'
        db.delete_column('purchase_cartstall', 'coupon_code')
