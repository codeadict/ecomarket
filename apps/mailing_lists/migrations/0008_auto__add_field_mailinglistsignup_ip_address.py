...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailingListSignup.ip_address'
        db.add_column('mailing_lists_mailinglistsignup', 'ip_address',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MailingListSignup.ip_address'
        db.delete_column('mailing_lists_mailinglistsignup', 'ip_address')
