...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        signups = MailingListSignup.objects.filter(source=LeadSources.UNKNOWN)
        signups.update(source=LeadSources.REGISTER_PAGE)

    def backwards(self, orm):
        "Write your backwards methods here."
        MailingListSignup = orm['mailing_lists.MailingListSignup']
        signups = MailingListSignup.objects.filter(
                source=LeadSources.REGISTER_PAGE)
        signups.update(source=LeadSources.UNKNOWN)
