...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailingListSignup'
        db.create_table('mailing_lists_mailinglistsignup', (
            ...
            ('telephone_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Country'], null=True)),
        ))
        db.send_create_signal('mailing_lists', ['MailingListSignup'])


    def backwards(self, orm):
        # Deleting model 'MailingListSignup'
        db.delete_table('mailing_lists_mailinglistsignup')
