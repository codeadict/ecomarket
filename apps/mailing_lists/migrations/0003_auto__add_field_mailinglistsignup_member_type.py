...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailingListSignup.member_type'
        db.add_column('mailing_lists_mailinglistsignup', 'member_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailingListSignup.member_type'
        db.delete_column('mailing_lists_mailinglistsignup', 'member_type')
