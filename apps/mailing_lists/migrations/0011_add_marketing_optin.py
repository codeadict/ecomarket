...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailingListSignup.marketing_optin'
        db.add_column('mailing_lists_mailinglistsignup', 'marketing_optin',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailingListSignup.marketing_optin'
        db.delete_column('mailing_lists_mailinglistsignup', 'marketing_optin')
