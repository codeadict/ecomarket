...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShippingAddress.country'
        db.delete_column('accounts_shippingaddress', 'country')


    def backwards(self, orm):
        # Adding field 'ShippingAddress.country'
        db.add_column('accounts_shippingaddress', 'country',
