...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailNotification.product_discounts'
        db.add_column('accounts_emailnotification', 'product_discounts',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailNotification.product_discounts'
        db.delete_column('accounts_emailnotification', 'product_discounts')
