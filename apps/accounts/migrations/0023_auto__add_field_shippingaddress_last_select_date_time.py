...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingAddress.last_select_date_time'
        db.add_column('accounts_shippingaddress', 'last_select_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingAddress.last_select_date_time'
        db.delete_column('accounts_shippingaddress', 'last_select_date_time')
