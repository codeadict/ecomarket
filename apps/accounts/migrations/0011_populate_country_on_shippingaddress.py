...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for shipping_address in orm.ShippingAddress.objects.all():
            try:
                country = orm['marketplace.Country'].objects.get(code=shipping_address.country)
            except orm['marketplace.Country'].DoesNotExist:
                country = uk
            shipping_address.country_new = country
