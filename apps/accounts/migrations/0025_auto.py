...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field used_discounts on 'UserProfile'
        db.create_table('accounts_userprofile_used_discounts', (
        ...
        db.create_unique('accounts_userprofile_used_discounts', ['userprofile_id', 'discount_id'])


    def backwards(self, orm):
        # Removing M2M table for field used_discounts on 'UserProfile'
        db.delete_table('accounts_userprofile_used_discounts')


    models = {
        'accounts.emailnotification': {
            'Meta': {'object_name': 'EmailNotification'},
            'blog_posts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
