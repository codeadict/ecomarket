...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_activities_update'
        db.add_column('accounts_userprofile', 'last_activities_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_activities_update'
        db.delete_column('accounts_userprofile', 'last_activities_update')
