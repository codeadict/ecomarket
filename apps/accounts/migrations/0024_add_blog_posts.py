...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailNotification.blog_posts'
        db.add_column('accounts_emailnotification', 'blog_posts',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailNotification.blog_posts'
        db.delete_column('accounts_emailnotification', 'blog_posts')
