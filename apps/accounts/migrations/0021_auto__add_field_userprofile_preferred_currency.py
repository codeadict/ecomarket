...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.preferred_currency'
        db.add_column('accounts_userprofile', 'preferred_currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.preferred_currency'
        db.delete_column('accounts_userprofile', 'preferred_currency')
