...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingAddress.country_new'
        db.add_column('accounts_shippingaddress', 'country_new',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Country'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingAddress.country_new'
        db.delete_column('accounts_shippingaddress', 'country_new_id')
