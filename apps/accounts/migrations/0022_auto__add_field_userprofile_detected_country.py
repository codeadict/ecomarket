...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.detected_country'
        db.add_column('accounts_userprofile', 'detected_country',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.detected_country'
        db.delete_column('accounts_userprofile', 'detected_country')
