...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            # Adding field 'MarketplaceMetadataPath.og_video'
            db.add_column('seo_marketplacemetadatapath', 'og_video',
                          self.gf('django.db.models.fields.CharField')(default='', max_length=511, blank=True),
                          keep_default=False)

            # Adding field 'MarketplaceMetadataPath.og_video'
            db.add_column('seo_marketplacemetadatamodel', 'og_video',
                          self.gf('django.db.models.fields.CharField')(default='', max_length=511, blank=True),
                          keep_default=False)

            # Adding field 'MarketplaceMetadataPath.og_video'
            db.add_column('seo_marketplacemetadataview', 'og_video',
                          self.gf('django.db.models.fields.CharField')(default='', max_length=511, blank=True),
                          keep_default=False)

            # Adding field 'MarketplaceMetadataPath.og_video'
            db.add_column('seo_marketplacemetadatamodelinstance', 'og_video',
                          self.gf('django.db.models.fields.CharField')(default='', max_length=511, blank=True),
                          keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'MarketplaceMetadataPath.og_video'
        db.delete_column('seo_marketplacemetadatapath', 'og_video')
        db.delete_column('seo_marketplacemetadataview', 'og_video')
        db.delete_column('seo_marketplacemetadatamodel', 'og_video')
        db.delete_column('seo_marketplacemetadatamodelinstance', 'og_video')
