...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailNotification.share_orders_in_activity_feed'
        db.add_column('accounts_emailnotification', 'share_orders_in_activity_feed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailNotification.share_orders_in_activity_feed'
        db.delete_column('accounts_emailnotification', 'share_orders_in_activity_feed')
