...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_publicly_viewable'
        db.add_column('accounts_userprofile', 'is_publicly_viewable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_publicly_viewable'
        db.delete_column('accounts_userprofile', 'is_publicly_viewable')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_publicly_viewable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
