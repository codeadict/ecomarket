...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('accounts_userprofile', ['country_id'])


    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.country_new' and its values cannot be restored.")
