...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.activities_last_checked_at'
        db.add_column('accounts_userprofile', 'activities_last_checked_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.activities_last_checked_at'
        db.delete_column('accounts_userprofile', 'activities_last_checked_at')
