...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoType.time_limit'
        db.add_column('accounts_videotype', 'time_limit',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoType.time_limit'
        db.delete_column('accounts_videotype', 'time_limit')
    ...
    models = {
        ...
        'accounts.videotype': {
            ...
            'time_limit': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '30'})
        },
        'actstream.action': {
