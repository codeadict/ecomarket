...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingAddress.country'
        db.alter_column('accounts_shippingaddress', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Country'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ShippingAddress.country'
        raise RuntimeError("Cannot reverse this migration. 'ShippingAddress.country' and its values cannot be restored.")
