...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('threadedcomments_threadedcomment', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='threadedcomment_comments', null=True, to=orm['auth.User'])),
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['threadedcomments.ThreadedComment'])),
    ...
    models = {
        ...
        'threadedcomments.threadedcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'ThreadedComment'},
