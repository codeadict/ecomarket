...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('image_crop_tempimage', (
            ...
            ('standardized', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('data', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('image_crop', ['TempImage'])


    def backwards(self, orm):
        # Deleting model 'TempImage'
        db.delete_table('image_crop_tempimage')
    ...
    models = {
        ...
        'image_crop.tempimage': {
            ...
            'standardized': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
