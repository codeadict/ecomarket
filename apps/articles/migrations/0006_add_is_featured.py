...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.is_featured'
        db.add_column('articles_attachment', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.is_featured'
        db.delete_column('articles_attachment', 'is_featured')
