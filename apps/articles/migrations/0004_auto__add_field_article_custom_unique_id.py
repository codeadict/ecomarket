...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.custom_unique_id'
        db.add_column('articles_article', 'custom_unique_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.custom_unique_id'
        db.delete_column('articles_article', 'custom_unique_id')
