...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_products on 'Article'
        db.create_table('articles_article_related_products', (
        ...
        db.create_unique('articles_article_related_products', ['article_id', 'product_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_products on 'Article'
        db.delete_table('articles_article_related_products')
