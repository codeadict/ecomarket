...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.seo_keyword'
        db.add_column('articles_article', 'seo_keyword',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.seo_meta_title'
        db.add_column('articles_article', 'seo_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.seo_keyword'
        db.delete_column('articles_article', 'seo_keyword')

        # Deleting field 'Article.seo_meta_title'
        db.delete_column('articles_article', 'seo_meta_title')
    ...
    models = {
        'articles.article': {
            ...
            'custom_unique_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'related_products': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['marketplace.Product']", 'symmetrical': 'False', 'blank': 'True'}),
            'rendered_content': ('django.db.models.fields.TextField', [], {}),
            'seo_keyword': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'seo_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
