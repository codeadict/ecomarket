...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_blogcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, db_index=True)),
            ...
            ('product_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blog_categories', to=orm['marketplace.Category'])),
        ))
        db.send_create_signal('articles', ['BlogCategory'])
        ...
        db.create_table('articles_article', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='articles', null=True, to=orm['articles.BlogCategory'])),
            ...
            ('use_addthis_button', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('articles_blogcategory')
