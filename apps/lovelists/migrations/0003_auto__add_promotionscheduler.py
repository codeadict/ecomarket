...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PromotionScheduler'
        db.create_table('lovelists_promotionscheduler', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('love_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lovelists.LoveList'])),
            ('actioned', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lovelists', ['PromotionScheduler'])


    def backwards(self, orm):
        # Deleting model 'PromotionScheduler'
        db.delete_table('lovelists_promotionscheduler')
    ...
    models = {
        ...
        'lovelists.lovelist': {
            ...
            'promoted': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'lovelists.promotionscheduler': {
            'Meta': {'ordering': "('-start_date',)", 'object_name': 'PromotionScheduler'},
            'actioned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'love_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lovelists.LoveList']"}),
