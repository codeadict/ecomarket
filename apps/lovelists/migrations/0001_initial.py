...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoveList'
        db.create_table('lovelists_lovelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='love_lists', to=orm['auth.User'])),
            ('primary_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='love_lists', to=orm['marketplace.Category'])),
            ('secondary_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+2', null=True, to=orm['marketplace.Category'])),
            ('tertiary_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+3', null=True, to=orm['marketplace.Category'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=155)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=True, max_length=50, separator=u'-', blank=True, populate_from='title', overwrite=True)),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('identifier', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True, max_length=8)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('lovelists', ['LoveList'])

        # Adding model 'LoveListProduct'
        db.create_table('lovelists_lovelistproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('love_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_relationships', to=orm['lovelists.LoveList'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Product'])),
            ('weight', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lovelists', ['LoveListProduct'])

        # Adding unique constraint on 'LoveListProduct', fields ['love_list', 'product']
        db.create_unique('lovelists_lovelistproduct', ['love_list_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LoveListProduct', fields ['love_list', 'product']
        db.delete_unique('lovelists_lovelistproduct', ['love_list_id', 'product_id'])

        # Deleting model 'LoveList'
        db.delete_table('lovelists_lovelist')

        # Deleting model 'LoveListProduct'
        db.delete_table('lovelists_lovelistproduct')
    ...
    models = {
        ...
        'lovelists.lovelist': {
            'Meta': {'ordering': "('-updated',)", 'object_name': 'LoveList'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.IntegerField', [], {'default': '0', 'unique': 'True', 'max_length': '8'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'primary_category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'love_lists'", 'to': "orm['marketplace.Category']"}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'love_lists'", 'symmetrical': 'False', 'through': "orm['lovelists.LoveListProduct']", 'to': "orm['marketplace.Product']"}),
            'secondary_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+2'", 'null': 'True', 'to': "orm['marketplace.Category']"}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'True', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'title'", 'overwrite': 'True'}),
            'tertiary_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+3'", 'null': 'True', 'to': "orm['marketplace.Category']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '155'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'love_lists'", 'to': "orm['auth.User']"})
        },
        'lovelists.lovelistproduct': {
            'Meta': {'ordering': "('weight',)", 'unique_together': "(('love_list', 'product'),)", 'object_name': 'LoveListProduct'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'love_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_relationships'", 'to': "orm['lovelists.LoveList']"}),
