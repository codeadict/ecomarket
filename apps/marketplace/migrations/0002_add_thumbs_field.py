...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.thumbnail'
        db.add_column('marketplace_productimage', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.thumbnail'
        db.delete_column('marketplace_productimage', 'thumbnail')
