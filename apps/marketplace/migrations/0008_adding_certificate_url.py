...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedCertificate.url'
        db.add_column('marketplace_suggestedcertificate', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Certificate.url'
        db.add_column('marketplace_certificate', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuggestedCertificate.url'
        db.delete_column('marketplace_suggestedcertificate', 'url')

        # Deleting field 'Certificate.url'
        db.delete_column('marketplace_certificate', 'url')
