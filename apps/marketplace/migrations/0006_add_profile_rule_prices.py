...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ShippingRule', fields ['profile', 'title']
        db.delete_unique('marketplace_shippingrule', ['profile_id', 'title'])

        # Deleting field 'ShippingRule.title'
        db.delete_column('marketplace_shippingrule', 'title')

        # Adding field 'ShippingRule.rule_price'
        db.add_column('marketplace_shippingrule', 'rule_price',
        ...
        # Adding field 'ShippingRule.rule_price_extra'
        db.add_column('marketplace_shippingrule', 'rule_price_extra',
                      self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, default=None, no_currency_field=True, max_digits=6, blank=True, null=True),
                      keep_default=False)

        # Adding field 'ShippingRule.rule_price_currency'
        db.add_column('marketplace_shippingrule', 'rule_price_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)

        # Adding field 'ShippingRule.rule_price_extra_currency'
        db.add_column('marketplace_shippingrule', 'rule_price_extra_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ShippingRule.title'
        db.add_column('marketplace_shippingrule', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, unique=True),
                      keep_default=False)

        # Deleting field 'ShippingRule.rule_price'
        db.delete_column('marketplace_shippingrule', 'rule_price')

        # Deleting field 'ShippingRule.rule_price_extra'
        db.delete_column('marketplace_shippingrule', 'rule_price_extra')

        # Deleting field 'ShippingRule.rule_price_currency'
        db.delete_column('marketplace_shippingrule', 'rule_price_currency')

        # Deleting field 'ShippingRule.rule_price_extra_currency'
        db.delete_column('marketplace_shippingrule', 'rule_price_extra_currency')

        # Adding unique constraint on 'ShippingRule', fields ['profile', 'title']
        db.create_unique('marketplace_shippingrule', ['profile_id', 'title'])
    ...
    models = {
        ...
        'marketplace.shippingrule': {
            ...
            'rule_price': ('money.contrib.django.models.fields.MoneyField', [], {'decimal_places': '2', 'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'blank': 'True', 'null': 'True'}),
            'rule_price_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': '"GBP"', 'max_length': '3'}),
            'rule_price_extra': ('money.contrib.django.models.fields.MoneyField', [], {'decimal_places': '2', 'default': 'None', 'no_currency_field': 'True', 'max_digits': '6', 'blank': 'True', 'null': 'True'}),
