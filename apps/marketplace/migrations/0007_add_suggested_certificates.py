...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuggestedCertificate'
        db.create_table('marketplace_suggestedcertificate', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggested_certificates', to=orm['marketplace.Product'])),
        ))
        db.send_create_signal('marketplace', ['SuggestedCertificate'])

        # Adding field 'ShippingRule.despatch_time'
        db.add_column('marketplace_shippingrule', 'despatch_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ShippingRule.delivery_time'
        db.add_column('marketplace_shippingrule', 'delivery_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SuggestedCertificate'
        db.delete_table('marketplace_suggestedcertificate')

        # Deleting field 'ShippingRule.despatch_time'
        db.delete_column('marketplace_shippingrule', 'despatch_time')

        # Deleting field 'ShippingRule.delivery_time'
        db.delete_column('marketplace_shippingrule', 'delivery_time')
