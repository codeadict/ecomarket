...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.email_opt_in'
        db.add_column('marketplace_stall', 'email_opt_in',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('marketplace_stall', 'email_opt_in')
    ...
    models = {
        ...
        'marketplace.stall': {
            ...
            'chat_stall_uri': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'chat_operator_uri': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
        },
