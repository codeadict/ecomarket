...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingProfile.others_delivery_time_max'
        db.alter_column('marketplace_shippingprofile', 'others_delivery_time_max', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ShippingProfile.others_delivery_time'
        db.alter_column('marketplace_shippingprofile', 'others_delivery_time', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ShippingProfile.others_delivery_time_max'
        db.alter_column('marketplace_shippingprofile', 'others_delivery_time_max', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ShippingProfile.others_delivery_time'
        db.alter_column('marketplace_shippingprofile', 'others_delivery_time', self.gf('django.db.models.fields.IntegerField')(default=0))
