...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Stall.phone_number'
        db.delete_column('marketplace_stall', 'phone_number')


    def backwards(self, orm):
        # Adding field 'Stall.phone_number'
        db.add_column('marketplace_stall', 'phone_number',
