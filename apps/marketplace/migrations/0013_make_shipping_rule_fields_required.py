...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingRule.rule_price'
        db.alter_column('marketplace_shippingrule', 'rule_price', self.gf('money.contrib.django.models.fields.MoneyField')(default=0, no_currency_field=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ShippingRule.rule_price'
        db.alter_column('marketplace_shippingrule', 'rule_price', self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, no_currency_field=True, max_digits=6, null=True))
