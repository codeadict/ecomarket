...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Price.price_currency'
        db.delete_column('marketplace_price', 'price_currency')

        # Deleting field 'Price.price'
        db.delete_column('marketplace_price', 'price')

        # Adding field 'Price.product'
        db.add_column('marketplace_price', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='prices', to=orm['marketplace.Product']),
                      keep_default=False)

        # Adding field 'Price.amount'
        db.add_column('marketplace_price', 'amount',
                      self.gf('money.contrib.django.models.fields.MoneyField')(default=0, no_currency_field=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Price.amount_currency'
        db.add_column('marketplace_price', 'amount_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)

        # Deleting field 'Product.price'
        db.delete_column('marketplace_product', 'price_id')


    def backwards(self, orm):
        # Adding field 'Price.price_currency'
        db.add_column('marketplace_price', 'price_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default="GBP", max_length=3),
                      keep_default=False)

        # Adding field 'Price.price'
        db.add_column('marketplace_price', 'price',
                      self.gf('money.contrib.django.models.fields.MoneyField')(default=0, no_currency_field=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Price.product'
        db.delete_column('marketplace_price', 'product_id')

        # Deleting field 'Price.amount'
        db.delete_column('marketplace_price', 'amount')

        # Deleting field 'Price.amount_currency'
        db.delete_column('marketplace_price', 'amount_currency')

        # Adding field 'Product.price'
        db.add_column('marketplace_product', 'price',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='product', to=orm['marketplace.Price']),
                      keep_default=False)
