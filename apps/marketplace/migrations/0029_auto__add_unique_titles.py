...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Recipient', fields ['title']
        db.create_unique('marketplace_recipient', ['title'])

        # Adding unique constraint on 'Material', fields ['title']
        db.create_unique('marketplace_material', ['title'])

        # Adding unique constraint on 'SuggestedCertificate', fields ['title']
        db.create_unique('marketplace_suggestedcertificate', ['title'])

        # Adding unique constraint on 'Color', fields ['title']
        db.create_unique('marketplace_color', ['title'])

        # Adding unique constraint on 'Certificate', fields ['title']
        db.create_unique('marketplace_certificate', ['title'])

        # Adding unique constraint on 'Cause', fields ['title']
        db.create_unique('marketplace_cause', ['title'])

        # Adding unique constraint on 'Keyword', fields ['title']
        db.create_unique('marketplace_keyword', ['title'])

        # Adding unique constraint on 'Ingredient', fields ['title']
        db.create_unique('marketplace_ingredient', ['title'])

        # Adding unique constraint on 'Occasion', fields ['title']
        db.create_unique('marketplace_occasion', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Occasion', fields ['title']
        db.delete_unique('marketplace_occasion', ['title'])

        # Removing unique constraint on 'Ingredient', fields ['title']
        db.delete_unique('marketplace_ingredient', ['title'])

        # Removing unique constraint on 'Keyword', fields ['title']
        db.delete_unique('marketplace_keyword', ['title'])

        # Removing unique constraint on 'Cause', fields ['title']
        db.delete_unique('marketplace_cause', ['title'])

        # Removing unique constraint on 'Certificate', fields ['title']
        db.delete_unique('marketplace_certificate', ['title'])

        # Removing unique constraint on 'Color', fields ['title']
        db.delete_unique('marketplace_color', ['title'])

        # Removing unique constraint on 'SuggestedCertificate', fields ['title']
        db.delete_unique('marketplace_suggestedcertificate', ['title'])

        # Removing unique constraint on 'Material', fields ['title']
        db.delete_unique('marketplace_material', ['title'])

        # Removing unique constraint on 'Recipient', fields ['title']
        db.delete_unique('marketplace_recipient', ['title'])
