...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.days_to_next_stockcheck_till_yesterday'
        db.add_column('marketplace_stall', 'days_to_next_stockcheck_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.days_to_next_stockcheck_till_yesterday'
        db.delete_column('marketplace_stall', 'days_to_next_stockcheck_till_yesterday')
    ...
    models = {
        ...
        'marketplace.product': {
            ...
            'flag': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'marketplace.stall': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'days_to_next_stockcheck_till_yesterday': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            ...
            'renewal_tier': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
