...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.image_src'
        db.add_column('marketplace_category', 'image_src',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.image_src'
        db.delete_column('marketplace_category', 'image_src')
