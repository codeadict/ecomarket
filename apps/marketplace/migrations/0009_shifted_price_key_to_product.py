...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('marketplace_product', 'price',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='product', to=orm['marketplace.Price']),
                      keep_default=False)
    ...
    models = {
        ...
        'marketplace.product': {
            ...
            'price': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product'", 'to': "orm['marketplace.Price']"}),
