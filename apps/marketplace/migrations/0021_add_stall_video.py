...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StallVideo'
        db.create_table('marketplace_stallvideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videos', to=orm['marketplace.Stall'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('is_welcome', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('marketplace', ['StallVideo'])


    def backwards(self, orm):
        # Deleting model 'StallVideo'
        db.delete_table('marketplace_stallvideo')
