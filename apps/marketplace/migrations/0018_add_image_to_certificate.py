...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.image'
        db.add_column('marketplace_certificate', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.image'
        db.delete_column('marketplace_certificate', 'image')
