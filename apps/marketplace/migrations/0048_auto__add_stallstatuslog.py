...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StallStatusLog'
        db.create_table('marketplace_stallstatuslog', (
        ...
        db.send_create_signal('marketplace', ['StallStatusLog'])


    def backwards(self, orm):
        # Deleting model 'StallStatusLog'
        db.delete_table('marketplace_stallstatuslog')
