...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.total_suspensions_till_yesterday'
        db.add_column('marketplace_stall', 'total_suspensions_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.total_suspensions_till_yesterday'
        db.delete_column('marketplace_stall', 'total_suspensions_till_yesterday')
