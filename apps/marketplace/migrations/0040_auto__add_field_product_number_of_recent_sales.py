...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.number_of_recent_sales'
        db.add_column('marketplace_product', 'number_of_recent_sales',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.number_of_recent_sales'
        db.delete_column('marketplace_product', 'number_of_recent_sales')
