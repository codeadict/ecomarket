...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.identifier'
        db.add_column('marketplace_stall', 'identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.identifier'
        db.delete_column('marketplace_stall', 'identifier')
