...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stall.total_gmv_till_yesterday'
        db.alter_column('marketplace_stall', 'total_gmv_till_yesterday', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Stall.total_gmv_till_yesterday'
        db.alter_column('marketplace_stall', 'total_gmv_till_yesterday', self.gf('money.contrib.django.models.fields.MoneyField')(no_currency_field=True, max_digits=6, decimal_places=2))
