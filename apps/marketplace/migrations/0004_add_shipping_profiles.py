...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ShippingProfile', fields ['title']
        db.delete_unique('marketplace_shippingprofile', ['title'])
        ...
        # Adding unique constraint on 'ShippingProfile', fields ['stall', 'title']
        db.create_unique('marketplace_shippingprofile', ['stall_id', 'title'])


    def backwards(self, orm):
        # Removing unique constraint on 'ShippingProfile', fields ['stall', 'title']
        db.delete_unique('marketplace_shippingprofile', ['stall_id', 'title'])
        ...
        # Adding unique constraint on 'ShippingProfile', fields ['title']
        db.create_unique('marketplace_shippingprofile', ['title'])
    ...
    models = {
        ...
        'marketplace.shippingprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shipping_from': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
