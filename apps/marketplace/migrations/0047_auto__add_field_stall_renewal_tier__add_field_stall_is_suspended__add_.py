...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.renewal_tier'
        db.add_column('marketplace_stall', 'renewal_tier',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Stall.is_suspended'
        db.add_column('marketplace_stall', 'is_suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Stall.reason_for_suspension'
        db.add_column('marketplace_stall', 'reason_for_suspension',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stall.last_stock_checked_at'
        db.add_column('marketplace_stall', 'last_stock_checked_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.renewal_tier'
        db.delete_column('marketplace_stall', 'renewal_tier')

        # Deleting field 'Stall.is_suspended'
        db.delete_column('marketplace_stall', 'is_suspended')

        # Deleting field 'Stall.reason_for_suspension'
        db.delete_column('marketplace_stall', 'reason_for_suspension')

        # Deleting field 'Stall.last_stock_checked_at'
        db.delete_column('marketplace_stall', 'last_stock_checked_at')
