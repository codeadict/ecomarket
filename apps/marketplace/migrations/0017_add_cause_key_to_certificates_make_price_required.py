...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.cause'
        db.add_column('marketplace_certificate', 'cause',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='certificates', to=orm['marketplace.Cause']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.cause'
        db.delete_column('marketplace_certificate', 'cause_id')
