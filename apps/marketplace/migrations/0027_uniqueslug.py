...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Stall', fields ['slug']
        db.create_unique('marketplace_stall', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Stall', fields ['slug']
        db.delete_unique('marketplace_stall', ['slug'])
