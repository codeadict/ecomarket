...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.is_chat_enabled'
        db.add_column('marketplace_stall', 'is_chat_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.is_chat_enabled'
        db.delete_column('marketplace_stall', 'is_chat_enabled')
