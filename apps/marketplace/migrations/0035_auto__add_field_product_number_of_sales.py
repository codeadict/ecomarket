...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.number_of_sales'
        db.add_column('marketplace_product', 'number_of_sales',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.number_of_sales'
        db.delete_column('marketplace_product', 'number_of_sales')
    ...
    models = {
        ...
        'marketplace.product': {
            ...
            'number_of_sales': ('django.db.models.fields.IntegerField', [], {}),
