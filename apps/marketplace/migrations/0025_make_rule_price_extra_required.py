...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingProfile.others_price_extra'
        db.alter_column('marketplace_shippingprofile', 'others_price_extra', self.gf('marketplace.fields.NullableMoneyField')(decimal_places=2, no_currency_field=True, max_digits=6, null=True))

        # Changing field 'ShippingProfile.others_price'
        db.alter_column('marketplace_shippingprofile', 'others_price', self.gf('marketplace.fields.NullableMoneyField')(decimal_places=2, no_currency_field=True, max_digits=6, null=True))

    def backwards(self, orm):

        # Changing field 'ShippingProfile.others_price_extra'
        db.alter_column('marketplace_shippingprofile', 'others_price_extra', self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, no_currency_field=True, max_digits=6, null=True))

        # Changing field 'ShippingProfile.others_price'
        db.alter_column('marketplace_shippingprofile', 'others_price', self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, no_currency_field=True, max_digits=6, null=True))
