...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.chat_stall_uri'
        db.add_column('marketplace_stall', 'chat_stall_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Stall.chat_operator_uri'
        db.add_column('marketplace_stall', 'chat_operator_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Stall.chat_stall_uri'
        db.delete_column('marketplace_stall', 'chat_stall_uri')

        # Deleting field 'Stall.chat_operator_uri'
        db.delete_column('marketplace_stall', 'chat_operator_uri')
