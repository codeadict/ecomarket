...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StallCallNotes'
        db.create_table('marketplace_stallcallnotes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='call_notes', to=orm['marketplace.Stall'])),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('marketplace', ['StallCallNotes'])

        # Adding field 'Stall.total_products_till_yesterday'
        db.add_column('marketplace_stall', 'total_products_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stall.total_live_products_till_yesterday'
        db.add_column('marketplace_stall', 'total_live_products_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stall.total_messages_received_till_yesterday'
        db.add_column('marketplace_stall', 'total_messages_received_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stall.number_of_calls'
        db.add_column('marketplace_stall', 'number_of_calls',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StallCallNotes'
        db.delete_table('marketplace_stallcallnotes')

        # Deleting field 'Stall.total_products_till_yesterday'
        db.delete_column('marketplace_stall', 'total_products_till_yesterday')

        # Deleting field 'Stall.total_live_products_till_yesterday'
        db.delete_column('marketplace_stall', 'total_live_products_till_yesterday')

        # Deleting field 'Stall.total_messages_received_till_yesterday'
        db.delete_column('marketplace_stall', 'total_messages_received_till_yesterday')

        # Deleting field 'Stall.number_of_calls'
        db.delete_column('marketplace_stall', 'number_of_calls')
