...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.publication_date'
        db.add_column('marketplace_product', 'publication_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Product.updated'
        db.alter_column('marketplace_product', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Product.created'
        db.alter_column('marketplace_product', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Deleting field 'Product.publication_date'
        db.delete_column('marketplace_product', 'publication_date')


        # Changing field 'Product.updated'
        db.alter_column('marketplace_product', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Product.created'
        db.alter_column('marketplace_product', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
