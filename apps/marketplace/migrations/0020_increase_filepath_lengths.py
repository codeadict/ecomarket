...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('marketplace_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Changing field 'ProductImage.thumbnail'
        db.alter_column('marketplace_productimage', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):
        # Changing field 'ProductImage.image'
        db.alter_column('marketplace_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'ProductImage.thumbnail'
        db.alter_column('marketplace_productimage', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
