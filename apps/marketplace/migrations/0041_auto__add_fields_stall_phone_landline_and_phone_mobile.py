...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StallOldStylePhoneNumber'
        db.create_table('marketplace_stalloldstylephonenumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stall', self.gf('django.db.models.fields.related.OneToOneField')(related_name='phone_old', unique=True, to=orm['marketplace.Stall'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('marketplace', ['StallOldStylePhoneNumber'])

        # Adding field 'Stall.phone_landline'
        db.add_column('marketplace_stall', 'phone_landline',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True),
                      keep_default=False)

        # Adding field 'Stall.phone_mobile'
        db.add_column('marketplace_stall', 'phone_mobile',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True),
                      keep_default=False)

        try:
            # Adding field 'Recipient.seo_title'
            db.add_column('marketplace_recipient', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Material.seo_title'
            db.add_column('marketplace_material', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'SuggestedCertificate.seo_title'
            db.add_column('marketplace_suggestedcertificate', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Color.seo_title'
            db.add_column('marketplace_color', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Certificate.seo_title'
            db.add_column('marketplace_certificate', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Cause.seo_title'
            db.add_column('marketplace_cause', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Keyword.seo_title'
            db.add_column('marketplace_keyword', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Ingredient.seo_title'
            db.add_column('marketplace_ingredient', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)

            # Adding field 'Occasion.seo_title'
            db.add_column('marketplace_occasion', 'seo_title',
                          self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                          keep_default=False)
        except Exception:
            pass
    ...
    def backwards(self, orm):
        # Deleting model 'StallOldStylePhoneNumber'
        db.delete_table('marketplace_stalloldstylephonenumber')

        # Deleting field 'Stall.phone_landline'
        db.delete_column('marketplace_stall', 'phone_landline')

        # Deleting field 'Stall.phone_mobile'
        db.delete_column('marketplace_stall', 'phone_mobile')

        return  # FIXME where were the below created?

        # Deleting field 'Recipient.seo_title'
        db.delete_column('marketplace_recipient', 'seo_title')

        # Deleting field 'Material.seo_title'
        db.delete_column('marketplace_material', 'seo_title')

        # Deleting field 'SuggestedCertificate.seo_title'
        db.delete_column('marketplace_suggestedcertificate', 'seo_title')

        # Deleting field 'Color.seo_title'
        db.delete_column('marketplace_color', 'seo_title')

        # Deleting field 'Certificate.seo_title'
        db.delete_column('marketplace_certificate', 'seo_title')

        # Deleting field 'Cause.seo_title'
        db.delete_column('marketplace_cause', 'seo_title')

        # Deleting field 'Keyword.seo_title'
        db.delete_column('marketplace_keyword', 'seo_title')

        # Deleting field 'Ingredient.seo_title'
        db.delete_column('marketplace_ingredient', 'seo_title')

        # Deleting field 'Occasion.seo_title'
        db.delete_column('marketplace_occasion', 'seo_title')
    ...
    models = {
        ...
        'marketplace.stall': {
            ...
            'phone_landline': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True'}),
