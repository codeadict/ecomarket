...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.is_in_video_beta'
        db.add_column('marketplace_stall', 'is_in_video_beta',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.is_in_video_beta'
        db.delete_column('marketplace_stall', 'is_in_video_beta')
    ...
    models = {
        ...
        'marketplace.stall': {
            ...
            'is_in_video_beta': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
