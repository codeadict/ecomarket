...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.slug'
        db.alter_column('marketplace_productimage', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=True, max_length=50, separator=u'-', populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'ProductImage.slug'
        db.alter_column('marketplace_productimage', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(populate_from='name', allow_duplicates=False, max_length=50, separator=u'-', overwrite=False))
