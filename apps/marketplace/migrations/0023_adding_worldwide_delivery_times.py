...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingProfile.others_delivery_time'
        db.add_column('marketplace_shippingprofile', 'others_delivery_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ShippingProfile.others_delivery_time_max'
        db.add_column('marketplace_shippingprofile', 'others_delivery_time_max',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingProfile.others_delivery_time'
        db.delete_column('marketplace_shippingprofile', 'others_delivery_time')

        # Deleting field 'ShippingProfile.others_delivery_time_max'
        db.delete_column('marketplace_shippingprofile', 'others_delivery_time_max')
