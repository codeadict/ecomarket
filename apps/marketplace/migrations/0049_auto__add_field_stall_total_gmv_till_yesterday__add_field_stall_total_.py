...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stall.total_gmv_till_yesterday'
        db.add_column('marketplace_stall', 'total_gmv_till_yesterday',
        ...
        # Adding field 'Stall.total_gmv_till_yesterday_currency'
        db.add_column('marketplace_stall', 'total_gmv_till_yesterday_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)

        # Adding field 'Stall.total_orders_till_yesterday'
        db.add_column('marketplace_stall', 'total_orders_till_yesterday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stall.is_active'
        db.add_column('marketplace_stall', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stall.total_gmv_till_yesterday'
        db.delete_column('marketplace_stall', 'total_gmv_till_yesterday')

        # Deleting field 'Stall.total_gmv_till_yesterday_currency'
        db.delete_column('marketplace_stall', 'total_gmv_till_yesterday_currency')

        # Deleting field 'Stall.total_orders_till_yesterday'
        db.delete_column('marketplace_stall', 'total_orders_till_yesterday')

        # Deleting field 'Stall.is_active'
        db.delete_column('marketplace_stall', 'is_active')
    ...
    models = {
        ...
        'marketplace.stall': {
            ...
            'total_gmv_till_yesterday': ('money.contrib.django.models.fields.MoneyField', [], {'default': '0', 'no_currency_field': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'total_gmv_till_yesterday_currency': ('money.contrib.django.models.fields.CurrencyField', [], {'default': "'GBP'", 'max_length': '3'}),
            'total_orders_till_yesterday': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
