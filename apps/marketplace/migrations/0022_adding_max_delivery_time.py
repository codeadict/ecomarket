...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingRule.delivery_time_max'
        db.add_column('marketplace_shippingrule', 'delivery_time_max',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingRule.delivery_time_max'
        db.delete_column('marketplace_shippingrule', 'delivery_time_max')
