...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.seo_title'
        db.alter_column('marketplace_category', 'seo_title', self.gf('django.db.models.fields.CharField')(max_length=511, null=True))

        # Changing field 'Category.description'
        db.alter_column('marketplace_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=511, null=True))

    def backwards(self, orm):

        # Changing field 'Category.seo_title'
        db.alter_column('marketplace_category', 'seo_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Category.description'
        db.alter_column('marketplace_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
