...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShippingRule'
        db.create_table('marketplace_shippingrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipping_rules', to=orm['marketplace.ShippingProfile'])),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('marketplace', ['ShippingRule'])

        # Adding model 'ShippingProfile'
        db.create_table('marketplace_shippingprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stall', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipping_profile', to=orm['marketplace.Stall'])),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('marketplace', ['ShippingProfile'])


    def backwards(self, orm):
        # Deleting model 'ShippingRule'
        db.delete_table('marketplace_shippingrule')

        # Deleting model 'ShippingProfile'
        db.delete_table('marketplace_shippingprofile')
    ...
    models = {
        ...
        'marketplace.shippingprofile': {
            'Meta': {'object_name': 'ShippingProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
