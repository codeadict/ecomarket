...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.navigation_name'
        db.add_column('marketplace_category', 'navigation_name',
                      self.gf('django.db.models.fields.CharField')(default='add me', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.navigation_name'
        db.delete_column('marketplace_category', 'navigation_name')
