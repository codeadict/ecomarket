...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('marketplace_price', 'created')

        # Deleting field 'Price.updated'
        db.delete_column('marketplace_price', 'updated')


    def backwards(self, orm):
        # Adding field 'Price.created'
        db.add_column('marketplace_price', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 10, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Price.updated'
        db.add_column('marketplace_price', 'updated',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2012, 10, 10, 0, 0), blank=True),
                      keep_default=False)
