...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('marketplace_currencyexchangerate', (
            ...
            ('exchange_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=6)),
        ))
        db.send_create_signal('marketplace', ['CurrencyExchangeRate'])


    def backwards(self, orm):
        # Deleting model 'CurrencyExchangeRate'
        db.delete_table('marketplace_currencyexchangerate')
