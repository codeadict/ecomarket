...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('marketplace_country', (
        ...
        db.send_create_signal('marketplace', ['Country'])

        # Adding field 'Product.shipping_profile'
        db.add_column('marketplace_product', 'shipping_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='products', to=orm['marketplace.ShippingProfile'], null=True),
                      keep_default=False)

        # Adding M2M table for field countries on 'ShippingRule'
        db.create_table('marketplace_shippingrule_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shippingrule', models.ForeignKey(orm['marketplace.shippingrule'], null=False)),
            ('country', models.ForeignKey(orm['marketplace.country'], null=False))
        ))
        db.create_unique('marketplace_shippingrule_countries', ['shippingrule_id', 'country_id'])

        # Deleting field 'ShippingProfile.shipping_from'
        db.delete_column('marketplace_shippingprofile', 'shipping_from')

        # Adding field 'ShippingProfile.slug'
        db.add_column('marketplace_shippingprofile', 'slug',
        ...
        # Adding field 'ShippingProfile.shipping_country'
        db.add_column('marketplace_shippingprofile', 'shipping_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, null=True, related_name='shipping_profile', to=orm['marketplace.Country']),
                      keep_default=False)

        # Adding field 'ShippingProfile.shipping_postcode'
        db.add_column('marketplace_shippingprofile', 'shipping_postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShippingProfile.others_price'
        db.add_column('marketplace_shippingprofile', 'others_price',
                      self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, default=None, no_currency_field=True, max_digits=6, blank=True, null=True),
                      keep_default=False)

        # Adding field 'ShippingProfile.others_price_extra'
        db.add_column('marketplace_shippingprofile', 'others_price_extra',
                      self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, default=None, no_currency_field=True, max_digits=6, blank=True, null=True),
                      keep_default=False)

        # Adding field 'ShippingProfile.others_price_currency'
        db.add_column('marketplace_shippingprofile', 'others_price_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)

        # Adding field 'ShippingProfile.others_price_extra_currency'
        db.add_column('marketplace_shippingprofile', 'others_price_extra_currency',
                      self.gf('money.contrib.django.models.fields.CurrencyField')(default='GBP', max_length=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('marketplace_country')

        # Deleting field 'Product.shipping_profile'
        db.delete_column('marketplace_product', 'shipping_profile_id')

        # Removing M2M table for field countries on 'ShippingRule'
        db.delete_table('marketplace_shippingrule_countries')

        # Adding field 'ShippingProfile.shipping_from'
        db.add_column('marketplace_shippingprofile', 'shipping_from',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'ShippingProfile.slug'
        db.delete_column('marketplace_shippingprofile', 'slug')

        # Deleting field 'ShippingProfile.shipping_country'
        db.delete_column('marketplace_shippingprofile', 'shipping_country_id')

        # Deleting field 'ShippingProfile.shipping_postcode'
        db.delete_column('marketplace_shippingprofile', 'shipping_postcode')

        # Deleting field 'ShippingProfile.others_price'
        db.delete_column('marketplace_shippingprofile', 'others_price')

        # Deleting field 'ShippingProfile.others_price_extra'
        db.delete_column('marketplace_shippingprofile', 'others_price_extra')

        # Deleting field 'ShippingProfile.others_price_currency'
        db.delete_column('marketplace_shippingprofile', 'others_price_currency')

        # Deleting field 'ShippingProfile.others_price_extra_currency'
        db.delete_column('marketplace_shippingprofile', 'others_price_extra_currency')
    ...
    models = {
        ...
        'marketplace.shippingrule': {
            'Meta': {'unique_together': "(('profile', 'title'),)", 'object_name': 'ShippingRule'},
            'countries': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'shipping_rules'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['marketplace.Country']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
