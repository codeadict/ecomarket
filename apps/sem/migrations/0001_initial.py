...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductAdWords'
        db.create_table('sem_productadwords', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_adword', to=orm['marketplace.Product'])),
            ('ad_group_id', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('status', self.gf('django.db.models.fields.CharField')(default='ENABLED', max_length=40)),
            ('campaign_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('cost', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('average_cpc', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('profit_banked', self.gf('money.contrib.django.models.fields.MoneyField')(decimal_places=2, default=None, no_currency_field=True, max_digits=6, blank=True, null=True)),
            ('profit_banked_currency', self.gf('money.contrib.django.models.fields.CurrencyField')(default="GBP", max_length=3)),
            ('clicks', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('impressions', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('conversions', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('total_sales', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('sem', ['ProductAdWords'])

        # Adding unique constraint on 'ProductAdWords', fields ['product', 'ad_group_id']
        db.create_unique('sem_productadwords', ['product_id', 'ad_group_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ProductAdWords', fields ['product', 'ad_group_id']
        db.delete_unique('sem_productadwords', ['product_id', 'ad_group_id'])

        # Deleting model 'ProductAdWords'
        db.delete_table('sem_productadwords')
    ...
    models = {
        ...
        'sem.productadwords': {
            ...
            'total_sales': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
