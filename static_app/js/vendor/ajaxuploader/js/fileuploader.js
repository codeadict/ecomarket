...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                o.instructions +
                '<div class="progress progress-striped active ecomarket-progress hide"><div class="bar" style="width: 0%;"></div></div>' +
                '<div class="qq-upload-drop-area"><span>Drop files here to upload</span></div>' +
                '<div class="qq-upload-button btn">Upload my photo</div>' +
